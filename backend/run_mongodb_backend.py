...
def main():
    ...
    if not os.environ.get("MONGODB_URI"):
        ...
        print("Example: MONGODB_URI=mongodb+srv://username:password@cluster.mongodb.net/knockoffkitchen")
        sys.exit(1)
    ...
    if not os.environ.get("OPENROUTER_API_KEY"):
        ...
        print("Example: OPENROUTER_API_KEY=sk-or-v1-xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx")
